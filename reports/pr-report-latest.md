...
## Executive Summary
There are **62** open PRs with the `project: rocprofiler-systems` label. **15** PRs need immediate attention due to failing CI or requested changes. **6** PRs are stale (3+ days without updates). CI health: 10 passing, 11 failing, 2 in progress, 39 unknown/no checks.
...
| [rocm-systems#4036](https://github.com/ROCm/rocm-systems/pull/4036) | [Rocprof-systems]: Enable KFD event tracing support | [@sputhala-amd](https://github.com/sputhala-amd) | ⏳ (cmake) | 🔄 (adjordje-amd) (prbasyal-amd) | 0d ago | 25d |
| [rocm-systems#3412](https://github.com/ROCm/rocm-systems/pull/3412) | [rocprofiler-systems] Enable re-attach | [@adjordje-amd](https://github.com/adjordje-amd) | ❌ (TheRock CI Summary, Linux (aqlprofile, rocprofiler-compute, rocprofiler-sdk, rocprofiler-systems) / Test / Test rocprofiler-sdk / Test rocprofiler-sdk (shard 1 of 1)) | 🔄 (dgaliffiAMD) | 0d ago | 46d |
...
| [rocm-systems#2594](https://github.com/ROCm/rocm-systems/pull/2594) | refactor: centralize output utilities from binaries into com... | [@habajpai-amd](https://github.com/habajpai-amd) | ❓ | 🔄 (mradosav-amd) | 0d ago | 84d |
...
| PR | Title | Author | CI | Review Status | Last Updated | Age |
|---|---|---|---|---|---|---|
| [rocm-systems#4712](https://github.com/ROCm/rocm-systems/pull/4712) | Bump tornado from 6.5.1 to 6.5.5 in /projects/rocprofiler-sy... | [@dependabot[bot]](https://github.com/dependabot[bot]) | ✅ | ❓ | 3d ago | 3d |
...
| [rocm-systems#2624](https://github.com/ROCm/rocm-systems/pull/2624) | docs: bump rocm-docs-core to 1.31.2 | [@peterjunpark](https://github.com/peterjunpark) | ❓ | ✅ (amd-jnovotny, dgaliffiAMD) | 4d ago | 82d |
| [rocm-systems#2542](https://github.com/ROCm/rocm-systems/pull/2542) | Improvement thread storage from std::array to stable_vector ... | [@anujshuk-amd](https://github.com/anujshuk-amd) | ❓ | ❓ | 40d ago | 89d |
| [rocm-systems#112](https://github.com/ROCm/rocm-systems/pull/112) | Extract correct gpu type for smi power metrics | [@systems-assistant[bot]](https://github.com/systems-assistant[bot]) | ❓ | ❓ | 40d ago | 244d |
...
| [rocm-systems#4436](https://github.com/ROCm/rocm-systems/pull/4436) | Bump rocm-docs-core from 1.32.1 to 1.33.1 in /projects/rocpr... | [@dependabot[bot]](https://github.com/dependabot[bot]) | ✅ | ✅ (alexxu-amd) | 0d ago | 12d |
...
| PR | Title | Author | CI | Review Status | Last Updated | Age |
|---|---|---|---|---|---|---|
| [rocm-systems#4758](https://github.com/ROCm/rocm-systems/pull/4758) | [Rocprof-systems]: PAPI build failure fix on Cray | [@sputhala-amd](https://github.com/sputhala-amd) | ⏳ | ✅ (dgaliffiAMD) | 0d ago | 0d |
...
- 📝 [rocm-systems#4605](https://github.com/ROCm/rocm-systems/pull/4605) — Update compiler on rhel-8 dockers ([@dgaliffiAMD](https://github.com/dgaliffiAMD), 6d old)
...
- 📝 [rocm-systems#4487](https://github.com/ROCm/rocm-systems/pull/4487) — [Test] Add TBB as a submodule and update to 2022.3 ([@dgaliffiAMD](https://github.com/dgaliffiAMD), 11d old)
...
- 📝 [rocm-systems#4170](https://github.com/ROCm/rocm-systems/pull/4170) — Users/dgaliffi/output summary tests ([@dgaliffiAMD](https://github.com/dgaliffiAMD), 20d old)
...
- 📝 [rocm-systems#3432](https://github.com/ROCm/rocm-systems/pull/3432) — [rocprofiler-systems] Replace ROCPROFSYS_VERBOSE with ROCPROFSYS_LOG_L ([@dgaliffiAMD](https://github.com/dgaliffiAMD), 44d old)
...
- 📝 [rocm-systems#1990](https://github.com/ROCm/rocm-systems/pull/1990) — Test refactor of build-docker.sh ([@dgaliffiAMD](https://github.com/dgaliffiAMD), 137d old)
...
- 📝 [rocm-systems#336](https://github.com/ROCm/rocm-systems/pull/336) — Add tests to improve coverage of rocprof-sys-causal.cpp ([@amkagade-Amd](https://github.com/amkagade-Amd), 237d old)
...
## CI Health Snapshot
Out of 62 open PRs: **10** passing, **11** failing, **2** in progress, and **39** with no checks or unknown status. Failing check names: `Linux (aqlprofile, hip-tests, rocgdb, rocprofiler-compute, rocprofiler-systems, rocr-debug-agent, rocrtst) / Test / Test rocrtst / Test rocrtst (shard 1 of 1)`, `Linux (aqlprofile, rocprofiler-compute, rocprofiler-sdk, rocprofiler-systems) / Test / Test rocprofiler-sdk / Test rocprofiler-sdk (shard 1 of 1)`, `Linux (aqlprofile, rocprofiler-compute, rocprofiler-sdk, rocprofiler-systems) / Test / Test rocprofiler-systems / Test rocprofiler-systems (shard 1 of 1)`, `Linux (hip-tests, rocprofiler-tests) / Test / Test aqlprofile`, `Linux (hip-tests, rocprofiler-tests) / Test / Test hip-tests`, `Linux (hip-tests, rocprofiler-tests) / Test / Test hipblas`, `Linux (hip-tests, rocprofiler-tests) / Test / Test hipblaslt`, `Linux (hip-tests, rocprofiler-tests) / Test / Test hipblaslt_plugin`, `Linux (hip-tests, rocprofiler-tests) / Test / Test hipcub`, `Linux (hip-tests, rocprofiler-tests) / Test / Test hipdnn-samples`, `Linux (hip-tests, rocprofiler-tests) / Test / Test hipfft`, `Linux (hip-tests, rocprofiler-tests) / Test / Test hiprand`, `Linux (hip-tests, rocprofiler-tests) / Test / Test hipsolver`, `Linux (hip-tests, rocprofiler-tests) / Test / Test libhipcxx_hipcc`, `Linux (hip-tests, rocprofiler-tests) / Test / Test libhipcxx_hiprtc`.

## What Changed Since Yesterday
(No previous report — this is day one.)

## Recommended Actions
1. [rocm-systems#4687](https://github.com/ROCm/rocm-systems/pull/4687) — fix failing CI.
...
12. [rocm-systems#3412](https://github.com/ROCm/rocm-systems/pull/3412) — fix failing CI and address review feedback from dgaliffiAMD.
...
15. [rocm-systems#2594](https://github.com/ROCm/rocm-systems/pull/2594) — address review feedback from mradosav-amd.
16. [rocm-systems#4712](https://github.com/ROCm/rocm-systems/pull/4712) — Stale for 3 days. Ping author [@dependabot[bot]](https://github.com/dependabot[bot]) for an update or consider closing.
17. [rocm-systems#4500](https://github.com/ROCm/rocm-systems/pull/4500) — Stale for 11 days. Ping author [@Muhamed-Husic](https://github.com/Muhamed-Husic) for an update or consider closing.
18. [rocm-systems#3962](https://github.com/ROCm/rocm-systems/pull/3962) — Stale for 6 days. Ping author [@kcossett-amd](https://github.com/kcossett-amd) for an update or consider closing.
19. [rocm-systems#2624](https://github.com/ROCm/rocm-systems/pull/2624) — Stale for 4 days. Ping author [@peterjunpark](https://github.com/peterjunpark) for an update or consider closing.
20. [rocm-systems#2542](https://github.com/ROCm/rocm-systems/pull/2542) — Stale for 40 days. Ping author [@anujshuk-amd](https://github.com/anujshuk-amd) for an update or consider closing.
